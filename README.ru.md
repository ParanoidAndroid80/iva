...
| Что | Цена |
|---|---|
| OpenCode Zen — API моделей | ~$5/мес |
| Ollama Cloud — API моделей | ~$20/мес |
| VPS — хватит и 512 МБ | $4–5/мес |

Выбираете одного провайдера; модель по умолчанию — deepseek-v4-pro с контекстом 131k. Итого около $9 в месяц, без наценки. Голос едет на бесплатном стартовом кредите Deepgram. Списки моделей, лимиты и матрица поисковых провайдеров: [docs/providers.md](docs/providers.md).
